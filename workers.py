...
def draw():
    global tile, choose, selectie
    screen = loadImage('Work.jpg')
    ...
    textSize(20)
    fill(250,250,250)
    text(str(objects.currentplayer.workers),200,155)
    
    #Worker usesd
    textSize(20)
    fill(250,250,250)
    text(str(objects.currentplayer.workers - objects.currentplayer.workers_used),200,181)    
    ...
    fill(0)
    text(recours_blok1,30,380)
    text(recours_blok2,140,380)
